...
urlpatterns = [
    ...
    path('sneakers/<int:sneaker_id>/assoc_sock/<int:sock_id>/', views.assoc_sock, name='assoc_sock'),
    path('sneakers/<int:sneaker_id>/unassoc_sock/<int:sock_id>/', views.unassoc_sock, name='unassoc_sock'),
    path('socks/', views.SockList.as_view(), name='socks_index'),
    # path('socks/<int:pk>/', views.SockDetail.as_view(), name='socks_detail'),
    path('socks/<int:pk>/', views.SockDetail.as_view(), name='socks_details'),
